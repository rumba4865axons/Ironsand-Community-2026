...
# 🎮 Ironsand — Community Edition

**Forge, build, and survive in a desert of iron.**
...
Ironsand is a survival-crafting simulation set in a sun-scorched desert where players harvest ironsand deposits, forge tools and machinery, and build outposts against the elements. This Community Edition is a standalone build delivered as a self-contained package: no storefront required, no additional software required, and it includes all content. The offline version is ready to play immediately after installation. LAN and direct connection supported for shared outpost play.

This build is for solo players and small groups who want a complete, self-contained survival-crafting simulation that runs offline on Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2454600/df1c745cc45607b9b4d1ad194c4692e58337b5bb/ss_df1c745cc45607b9b4d1ad194c4692e58337b5bb.1920x1080.jpg?t=1788430412" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2454600/48b8cc7330e0d239c0ff8c902249db7de0d76d45/ss_48b8cc7330e0d239c0ff8c902249db7de0d76d45.1920x1080.jpg?t=1788430412" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2454600/acedea396916b2a1b255c0c6c3617588beebbdff/ss_acedea396916b2a1b255c0c6c3617588beebbdff.1920x1080.jpg?t=1788430412" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏜️ **Open Desert World** — Explore a hand-crafted open-world desert with dunes, canyons, and buried ruins.
- ⚒️ **Deep Forging System** — Refine ironsand into alloys through a multi-stage smelting and smithing chain.
- 🏗️ **Modular Base Building** — Construct outposts from structural frames, defenses, and production lines.
- 🌡️ **Heat and Sandstorms** — Manage hydration, shelter, and equipment wear against dynamic weather.
- 🛠️ **Sandbox Simulation** — Free-form resource management with no fixed objectives beyond survival.
- 🌱 **Water Economy** — Extract, purify, and recycle water as the core constraint of every outpost.
- 🤝 **Shared Outpost Play** — LAN or direct connection supported for building together.
- 📦 **Complete Package** — Standalone build that includes all content and community patches to date.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~9 minutes on HDD
- **Recoding:** none
- **Selective Download:** Full package only; all content included

---

## 📦 DLCs Included

- Ironsand: Foundry Expansion
- Ironsand: Dune Rigs Pack
...
| **Storage** | 12 GB available space | 14 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | SSD storage recommended for faster world streaming |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Ironsand\Saved`
